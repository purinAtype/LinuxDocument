...
if [ -d "$outputpath/zaikoResult" ]; then
  echo $header > $outputpath/zaikoResult
  join -t , -a 1 -1 5 -2 1 -o '1.1 1.2 1.3 1.4 0 2.2' -e 'NULL' $inputpath/shouhinTable $inputpath/soukoTable >> $outputpath/zaikoResult
else
  touch $outputpath/zaikoResult
  echo $header > $outputpath/zaikoResult
  join -t , -a 1 -1 5 -2 1 -o '1.1 1.2 1.3 1.4 0 2.2' -e 'NULL' $inputpath/shouhinTable $inputpath/soukoTable >> $outputpath/zaikoResult
fi